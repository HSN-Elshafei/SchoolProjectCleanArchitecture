...
namespace SchoolProject.Core.Wrappers
{
	...
	{
		public static async Task<PaginatedResult<T>> ToPaginatedResult<T>(this IQueryable<T> source, int pageNumber, int pageSize)
			where T : class
		{
			if (source == null) throw new Exception("empity");
