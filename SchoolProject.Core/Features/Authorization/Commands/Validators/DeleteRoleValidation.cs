...
{
	public class DeleteRoleValidation : RoleValidation<DeleteRoleCommand>
	{
		#region Fields
		...
		#region Ctor
		public DeleteRoleValidation(IAuthorizationService authorizationService, IStringLocalizer<SharedResources> stringLocalizer) : base(authorizationService, stringLocalizer)
		{
