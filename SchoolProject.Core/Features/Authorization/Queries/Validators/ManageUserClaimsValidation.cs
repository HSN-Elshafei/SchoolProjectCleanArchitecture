...
{
	public class ManageUserClaimsValidation : AuthorizationValidation<ManageUserClaimsQuery>
	{
		#region Fields
		...
		#region Ctor
		public ManageUserClaimsValidation(IAuthorizationService authorizationService, IStringLocalizer<SharedResources> stringLocalizer) : base(authorizationService, stringLocalizer)
		{
