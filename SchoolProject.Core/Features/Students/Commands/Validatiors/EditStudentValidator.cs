...
namespace SchoolProject.Core.Features.Students.Commands.Validatiors
{
	public class EditStudentValidator : StudentValidator<EditStudentCommand>
	{
		...
		#region Ctor
		public EditStudentValidator(IStudentService studentService, IStringLocalizer<SharedResources> stringLocalizer, IDepartmentService departmentService) : base(studentService, stringLocalizer, departmentService)
		{
